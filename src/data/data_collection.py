...
file_path = os.path.join(folder_path, 'schitts_creek_dialogues_raw.csv')

# Write to CSV in the folder
...
print("Dialogues have been saved to schitts_creek_dialogues_raw.csv.")